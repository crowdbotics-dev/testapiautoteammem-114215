...
## Project Structure
    ...
    ├── testapiautoteammem_114215  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_114215`
...
2. Clone this repo and `cd testapiautoteammem_114215`
